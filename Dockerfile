...
# Build the specific NestJS application (replace 'your-nestjs-app' with your app's name)
RUN npx nx build your-nestjs-app --prod
...
COPY --from=builder /app/dist/apps/your-nestjs-app ./dist
